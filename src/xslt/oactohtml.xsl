...
<xsl:stylesheet 
    ...
    <xsl:template match="oac:Annotation">
        ...
        <footer>
            <a id="perseuslogo" href="http://www.perseus.tufts.edu/hopper"><img src="http://catalog.perseus.org/assets/running_man-399db874bb0195667b079b52ba3d1e03.png"/></a>
            <a id="perseidslogo" href="http://sites.perseus.tufts.edu/perseids"><img src="http://sosol.perseids.org/sosol/images/perseids_notag_150.png"/></a>
            <div class="copyright">
                This work is licensed under a 
                <a rel="license" href="http://creativecommons.org/licenses/by-sa/3.0/us/">Creative Commons Attribution-ShareAlike 3.0 United States License</a>.</div>
            <div class="clear"></div>
        </footer>
    </xsl:template>
