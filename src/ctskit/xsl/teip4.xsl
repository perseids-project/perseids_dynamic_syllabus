<xsl:stylesheet
  ...
  <xsl:template match="/">
    <div class="text_container {$lang}">
     <div class="text">
	     <xsl:apply-templates select="ptext:pack|ptext:front|/tei:TEI.2/tei:text/tei:front|/tei:tei.2/tei:text/tei:front|ptext:body|/TEI/tei:text/tei:front|tei:tei/tei:text/tei:front|/tei:TEI.2/tei:text/tei:body|tei:TEI/tei:text/tei:body|tei:tei/tei:text/tei:body|ptext:back|/tei:tei.2/tei:text/tei:back|/tei:TEI/tei:text/tei:back|tei:tei/tei:text/tei:back|/tei:TEI.2/tei:text/tei:back|/tei:TEI.2/tei:text/tei:group/tei:text|/tei:TEI/tei:text/tei:group/tei:text|tei:tei/tei:text/tei:group/tei:text"/>
     <xsl:text> </xsl:text>
     </div>
